...
class Monster(DungeonCharacter, ABC):
    ...
    def __init__(self, name, hit_points, attack_speed, chance_to_hit, min_damage, max_damage, chance_to_heal,
    ...
    def hit_points(self):
        ...
        print(self.get_attribute("hit_points"))
