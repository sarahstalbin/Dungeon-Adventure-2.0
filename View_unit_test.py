...
class TestView(unittest.TestCase):
    ...
    def test_introduction(self):
        expected_output = "\nWelcome to the Dungeon Adventure Game, where you may traverse a dangerous maze in hopes \nof finding the 4 pillars of Object Oriented Programing (OOP) - Abstraction, Encapsulation, \nInheritance, and Polymorphism. Within the dungeon's maze you will find surprises, such \nas healing potions, vision potions, or pits. Items will be stored and healing potions \ncan be used to increase your HP, or health points. The Vision potion allows you to see \nthrough the walls of surrounding rooms. Falling into a pit will lower your HP. Be careful \nnot to die and lose the game. Survive and find all pillars of OOP to win. \n \nTo travel, press keys w for Up, s for Down, a for Left, and d for Right. \nPress \"m\" to view menu options for legend key.\n\n"
    ...
    def test_special_attack_results_warrior_success(self):
        ...
        with patch('builtins.print') as mock_print:
            View.special_attack_results(result, hero, "Warrior", monster)
